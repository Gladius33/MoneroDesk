    ...
    if created and instance.status == 'completed':
        try:
            ...
            if instance.ad.type == 'sell':
                monero_service.release_funds(instance.escrow_wallet_address, instance.buyer.profile.user_subaddress)
                logger.info(f"Released escrow funds for Transaction {instance.transaction_id} to buyer.")
            elif instance.ad.type == 'buy':
                monero_service.release_funds(instance.escrow_wallet_address, instance.seller.profile.user_subaddress)
